...
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="layout.app" href="today_order.html">');
document.write('                      <span>当日预订</span>');
document.write('                    </a>');
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="layout.fullwidth" href="all_order.html">');
...
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="app.ui.timeline" href="vip.html">');
...
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="app.table.static" href="consume_chart.html">');
document.write('                      <span translate="aside.nav.components.table.TABLE_STATIC">营业额报表</span>');
document.write('                    </a>');
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="app.table.datatable" href="dish_chart.html">');
document.write('                      <span translate="aside.nav.components.table.DATATABLE">菜品类报表</span>');
document.write('                    </a>');
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="app.table.footable" href="number_chart.html">');
...
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="app.form.elements" href="dish.html">');
...
document.write('                  </li>');
document.write('                  <li ui-sref-active="active">');
document.write('                    <a ui-sref="app.page.price" href="worker.html">');
